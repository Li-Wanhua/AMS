clear all
close all
filePath='/home/share/chaLearn-Iso/IsoGD_phase_2/';
fileListName=['fake_test_list.txt'];
...
% videoPlayerJF(depV,0.01,0)
    ...
    basePath = ['/home/share/chaLearn-Iso/Seq/' trainDEPVideoPaths{indListSel,1}(1:9) trainDEPVideoPaths{indListSel,1}(12:end-4) '/'];
